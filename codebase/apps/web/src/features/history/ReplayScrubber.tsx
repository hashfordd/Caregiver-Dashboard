  ...
  return (
    <div className="space-y-3">
      {truncated && (
        ...
        >
          Showing first {MAX_HISTORY_ROWS.toLocaleString()} rows · narrow the window for full
          coverage.
        </p>
      )}
      {/* Controls */}
      ...
      <label className="block">
        ...
        <span className="sr-only">
          Use Space to play or pause, arrow keys to scrub one frame, Shift+arrow to scrub ten
          frames.
        </span>
        <input
          type="range"
