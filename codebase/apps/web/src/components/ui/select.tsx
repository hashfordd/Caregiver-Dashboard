...
// Shadcn-style wrapper around @radix-ui/react-select. Mirrors the
// dialog.tsx / dropdown-menu.tsx primitive pattern so the dark-theme
// Tailwind tokens land consistently across all overlays.
